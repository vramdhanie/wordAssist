        ...
        <Wrapper>
            <Form>
                <Box>
                    ...
                    <Input
                        onChange={(e) => setLetterstoInclude(e.target.value)}
                        value={lettersToInclude}
                    />
                </Box>
                <Box>
                ...
                <Box>
                    ...
                    <Input
                        onChange={(e) => setLetterstoExclude(e.target.value)}
            ...
            <Information>
                <Box>
                    {showing || hiding ? (
                        <Box>
                            {showing && (
                                <Text>Showing words containing the letters: {showing}</Text>
                            )}
